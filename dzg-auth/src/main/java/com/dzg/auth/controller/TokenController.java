package com.dzg.auth.controller;
...
import com.dzg.auth.domain.vo.LoginTenantVo;
import com.dzg.auth.domain.vo.LoginVo;
import com.dzg.auth.domain.vo.TenantListVo;
import com.dzg.auth.form.RegisterBody;
import com.dzg.auth.form.SocialLoginBody;
...
import com.dzg.common.core.domain.model.LoginBody;
import com.dzg.common.core.utils.*;
import com.dzg.common.encrypt.annotation.ApiEncrypt;
import com.dzg.common.json.utils.JsonUtils;
import com.dzg.common.ratelimiter.annotation.RateLimiter;
import com.dzg.common.ratelimiter.enums.LimitType;
import com.dzg.common.satoken.utils.LoginHelper;
import com.dzg.common.social.config.properties.SocialLoginConfigProperties;
import com.dzg.common.social.config.properties.SocialProperties;
import com.dzg.common.social.utils.SocialUtils;
import com.dzg.common.tenant.helper.TenantHelper;
import com.dzg.resource.api.RemoteMessageService;
import com.dzg.system.api.RemoteClientService;
import com.dzg.system.api.RemoteConfigService;
import com.dzg.system.api.RemoteSocialService;
...
public class TokenController {
    ...
    public R<LoginVo> login(@RequestBody String body) {
        ...
        scheduledExecutorService.schedule(() -> {
            remoteMessageService.publishMessage(List.of(userId), DateUtils.getTodayHour(new Date()) + "好，欢迎登录 店掌柜智慧零售管理系统 后台管理系统");
        }, 5, TimeUnit.SECONDS);
        return R.ok(loginVo);
    }

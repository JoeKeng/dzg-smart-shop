...
create table if not exists dzg_category (
...
create table if not exists dzg_product (
...
set @sql = (
    ...
    where table_schema = 'dzg_shop' and table_name = 'dzg_product' and column_name = 'image_oss_id'
);
prepare stmt from @sql;
execute stmt;
deallocate prepare stmt;

insert ignore into dzg_category values
...
create table if not exists dzg_stock (
...
create table if not exists dzg_stock_log (
...
create table if not exists dzg_customer (
...
create table if not exists dzg_order (
...
create table if not exists dzg_order_item (
...
create table if not exists dzg_credit_record (
...
create table if not exists dzg_repayment (
...
delete from sys_menu where menu_id in (
    20000, 20001, 20002, 20003, 20004, 20005, 20006, 20007, 20008, 20009, 20010, 20011, 20100, 20101, 20102,
    20031, 20032, 20033, 20041, 20051, 20052, 20061, 20081, 20091, 20092, 20093
);

...
import com.dzg.common.mybatis.enums.DataBaseType;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("com.dzg.common.translation.annotation.Translation");
                importList.add("com.dzg.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }

package com.dzg.workflow.service.impl;
...
import com.dzg.common.core.enums.BusinessStatusEnum;
import com.dzg.common.core.exception.ServiceException;
import com.dzg.common.core.utils.StreamUtils;
import com.dzg.common.core.utils.StringUtils;
import com.dzg.common.core.utils.ValidatorUtils;
import com.dzg.common.core.validate.AddGroup;
import com.dzg.common.core.validate.EditGroup;
...
import com.dzg.common.mybatis.utils.IdGeneratorUtil;
import com.dzg.common.satoken.utils.LoginHelper;
import com.dzg.system.api.RemoteUserService;
import com.dzg.system.api.domain.vo.RemoteUserVo;
import com.dzg.warm.flow.core.FlowEngine;
import com.dzg.warm.flow.core.constant.ExceptionCons;
import com.dzg.warm.flow.core.dto.FlowCombine;
import com.dzg.warm.flow.core.dto.FlowParams;
import com.dzg.warm.flow.core.entity.*;
import com.dzg.warm.flow.core.enums.CooperateType;
import com.dzg.warm.flow.core.enums.NodeType;
import com.dzg.warm.flow.core.enums.SkipType;
import com.dzg.warm.flow.core.enums.UserType;
import com.dzg.warm.flow.core.exception.FlowException;
import com.dzg.warm.flow.core.service.*;
import com.dzg.warm.flow.core.utils.ExpressionUtil;
import com.dzg.warm.flow.core.utils.MapUtil;
import com.dzg.warm.flow.orm.entity.*;
import com.dzg.warm.flow.orm.mapper.FlowHisTaskMapper;
import com.dzg.warm.flow.orm.mapper.FlowInstanceMapper;
import com.dzg.warm.flow.orm.mapper.FlowNodeMapper;
import com.dzg.warm.flow.orm.mapper.FlowTaskMapper;
...
import com.dzg.workflow.common.enums.TaskAssigneeType;
import com.dzg.workflow.common.enums.TaskOperationEnum;
import com.dzg.workflow.common.enums.TaskStatusEnum;
import com.dzg.workflow.domain.FlowInstanceBizExt;
import com.dzg.workflow.domain.bo.*;
import com.dzg.workflow.domain.vo.FlowCopyVo;
import com.dzg.workflow.domain.vo.FlowHisTaskVo;
import com.dzg.workflow.domain.vo.FlowTaskVo;
import com.dzg.workflow.domain.vo.NodeExtVo;
import com.dzg.workflow.mapper.FlwCategoryMapper;
import com.dzg.workflow.mapper.FlwInstanceBizExtMapper;
import com.dzg.workflow.mapper.FlwTaskMapper;
import com.dzg.workflow.service.IFlwCommonService;
import com.dzg.workflow.service.IFlwNodeExtService;
import com.dzg.workflow.service.IFlwTaskAssigneeService;
import com.dzg.workflow.service.IFlwTaskService;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;

import java.util.*;

import static com.dzg.workflow.common.constant.FlowConstant.*;

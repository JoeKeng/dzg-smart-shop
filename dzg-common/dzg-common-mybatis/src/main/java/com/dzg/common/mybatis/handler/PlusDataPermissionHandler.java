package com.dzg.common.mybatis.handler;
...
import com.dzg.common.mybatis.enums.DataScopeType;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/Dzg-Vue-Plus/issues/IB4CS4
